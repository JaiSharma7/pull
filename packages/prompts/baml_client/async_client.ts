...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async WriteCanonicalSummary(
        workTitle: string,kind: string,context: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.CanonicalSummary> {
          try {
          ...
          const __stream__ = this.stream.WriteCanonicalSummary(
          workTitle,kind,context,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            {
            "workTitle": workTitle,"kind": kind,"context": context
            },
            ...
            return __raw__.parsed(false) as types.CanonicalSummary
            } catch (error) {
            ...
            workTitle: string,kind: string,context: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.CanonicalSummary, types.CanonicalSummary>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}), env: { ...(this.bamlOptions.env || {}), ...(__baml_options__?.env || {}) } }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for WriteCanonicalSummary", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.CanonicalSummary, types.CanonicalSummary>(
                  __raw__,
                  (a): partial_types.CanonicalSummary => a,
                  (a): types.CanonicalSummary => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
