...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Download everything**     | Every row stored against your account, as one JSON file — including each recall attempt as it happened, the seeds that decided your reading order, and the vector described above. Paged, so a large library is not silently truncated at a hundred rows. Two things are held back on purpose: your unspent recovery codes, which exist to be shown once and not written into a file you might email yourself, and the operational rate counters, which are not yours in any meaningful sense. |
